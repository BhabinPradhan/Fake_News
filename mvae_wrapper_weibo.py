...
class MVAEModelWeibo(nn.Module):
    def __init__(self):
        super().__init__()
...
class MVAEInferenceWeibo:
    def __init__(self, model_path="/home/vongoct/checkpoints/mvae_weibo.pth", device="cpu"):
        self.device = device
        self.model = MVAEModelWeibo().to(self.device)
